-- Manual Migration 008: Add Cascading Soft Delete Triggers
-- Run this in Supabase SQL Editor to add automatic cascading soft delete behavior
...
WHERE trigger_name LIKE 'trigger_cascade_soft_delete%'
